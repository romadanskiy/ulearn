...
namespace FractalPainting.App
{
        ...
        public static StandardKernel ConfigureContainer()
        {
            ...
            */
            ...
            container.Bind<SettingsManager>()
                .ToMethod(c => new SettingsManager(c.Kernel.Get<IObjectSerializer>(), c.Kernel.Get<IBlobStorage>()));
            
            container.Bind<AppSettings>()
                .ToMethod(c => c.Kernel.Get<SettingsManager>().Load()).InSingletonScope();
            container.Bind<ImageSettings>()
                .ToMethod(c => c.Kernel.Get<AppSettings>().ImageSettings).InSingletonScope();
    ...
    public class DragonFractalAction : IUiAction
    {
        ...
        */
        ...
        // 5.2
        private readonly Func<DragonSettings, DragonPainter> _dragonPainterFactory;
        ...
        public void Perform()
        {
            ...
            // var painter = _dragonPainterFactory.CreateDragonPainter(dragonSettings); // 5.1
            var painter = _dragonPainterFactory(dragonSettings); // 5.2
            painter.Paint();
        }
    ...
    public class KochFractalAction : IUiAction
    {
        ...
        public void Perform()
        {
            var painter = _kochPainter.Value;
            painter.Paint();
        }
    }
